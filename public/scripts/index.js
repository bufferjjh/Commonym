...
fetch('/getUsersOnline')
    .then((r) => r.json())
    .then(data => {
        document.getElementById("RapidRecallPlaying").innerHTML = "• " + Math.max(0,data.RapidRecall) + " playing";
        document.getElementById("CountdownPlaying").innerHTML = "• " + Math.max(0,data.Countdown) + " playing";
        document.getElementById("WordDrawPlaying").innerHTML = "• " + Math.max(0,data.WordDraw) + " playing";
