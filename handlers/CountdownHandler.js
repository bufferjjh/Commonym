...
module.exports = (io, socket, WordChecker, GameUsers, Game, client) => {
    ...
    socket.on("Countdown:StartPrivateGame", (res) => {
        try {
            ...
            console.log("Error occured in Countdown:StartPrivateGame");
        }
    });
    socket.on("Countdown:JoinPrivate", (res) => {
        try {
            ...
            console.log("Error occured in Countdown:JoinPrivate")
        }
    });
    socket.on("Countdown:Connect", (gameName) => {
        try {
            ...
            console.log("Error occured in Countdown:Connect");
        }
    });
    socket.on('Countdown:FirstPlayerWord', (word) => {
        try {
            ...
            console.log("Error occured in Countdown:FirstPlayerWord");
        }
    });
    socket.on('Countdown:WordSent', (word) => {
        try {
            ...
            console.log("Countdown:WordSent");
        }
    });
    socket.on("Countdown:LetterType", (word) => {
        try {
            ...
            console.log("Error occured in Countdown:LetterType");
        }
    });
    socket.on("Countdown:Timeout", () => {
        try {
            ...
            console.log("Error occured in Countdown:Timeout");
        }
    });
}
...
function checkStartingWord(word, currGame, WordChecker) {
    try {
        ...
        console.log("Error in checkStartingWord");
    }
}
